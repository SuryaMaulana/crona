		...
		<div class="jumbotron">
			<div class="container"><br><br>
				...
				<h5 class="lead m-0 text-center">
					<small class="lead">Hubungi kami jika kalian menemukan masalah dalam menggunakan website ini.</small>
				</h5>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6">
					<div class="card service">
						<div class="card-body">
							<div class="media">
								<img src="/images/alfan.jpg" alt="Alfan Jauhari" style="width: 100px; height: 100px; border-radius: 100%">
								<div class="media-body ml-4">
									<h3 class="mt-0 mb-0 font-weight-bold">Alfan Jauhari</h3>
									<h5 class="small">Web Backend Developer</h5>
